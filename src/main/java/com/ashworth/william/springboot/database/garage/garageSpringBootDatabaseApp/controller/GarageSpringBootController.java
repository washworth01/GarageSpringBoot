...
public class GarageSpringBootController 
{
	...
	public GarageSpringBootModel getVehicleID(@PathVariable(value = "id")Long vehicleID)
	{
	...
	{
		GarageSpringBootModel gSDM = garageRepository.findById(vehicleID).orElseThrow(()-> new ResourceNotFoundException("Vehicle", "id", vehicleID));
